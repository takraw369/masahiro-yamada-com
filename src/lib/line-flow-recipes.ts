...
export const STARTER_RECIPES: StarterRecipe[] = [
  {
    ...
    steps: [
      ...
      },
      {
        offsetDays: 1,
        angle: '現在地',
        message: '今いちばん整えたいものを一つ選ぶなら、「身体・思考・感情・行動」のどれに近いですか？正解はなく、今の感覚で大丈夫です。',
      },
      {
        offsetDays: 3,
        angle: '小さな体験',
      ...
      },
      {
        offsetDays: 5,
        angle: '理解',
        message: '行動を変える前に、何が噛み合っていないかが見えると選び方が変わります。ここまでで「前より分かった」と感じることはありますか？',
      },
      {
        offsetDays: 7,
        angle: '自己選択',
        message: 'ここから先は、今の自分に必要な方向を選べます。「もう少し深める」「別テーマを見る」「いったん休む」のどれが近いですか？',
      },
    ],
  },
  {
    ...
    icon: '🧭',
    name: '診断導線｜5通',
    purpose: '問い → 診断 → 結果理解 → 小さな実験 → 次の選択。診断をラベルで終わらせず、行動に接続する。',
    triggerType: 'manual',
    steps: [
      {
        offsetDays: 0,
        angle: '問い',
        message: '今の状態を決めつける前に、まず「どこが噛み合っていないか」を見てみませんか？短いチェックから始められます。',
      },
      {
        offsetDays: 0,
        offsetMinutes: 20,
        angle: '診断',
        message: 'チェックは点数を競うものではなく、今の状態の地図をつくるためのものです。気になる項目だけでも見てみてください。',
      },
      {
        offsetDays: 1,
        angle: '結果理解',
        message: '結果を見る時は「良い・悪い」より、どこに偏りや詰まりがあるかを見ると使いやすくなります。いちばん気になった部分はどこでしたか？',
      },
      {
        offsetDays: 3,
        angle: '小さな実験',
        message: '結果から一つだけ選び、1〜3分で試せることにしてみましょう。変化が小さくても、前後の違いを拾えれば十分です。',
      },
      {
        offsetDays: 5,
        angle: '次の選択',
        message: 'ここまでの観察を踏まえて、次は「続ける」「別の項目を見る」「少し置く」から選べます。今いちばん自然なのはどれですか？',
      },
    ],
  },
  {
    ...
    icon: '📚',
    name: '教育｜7通',
    purpose: '問い → Why → Reframe → 体験 → Story → 統合 → 次の一歩。知識を受け取るだけで終わらせない。',
    triggerType: 'manual',
    steps: [
  ...
  },
  {
    ...
    icon: '🚪',
    name: '商品・サービス｜5通',
    purpose: '課題理解 → 選択肢 → 具体像 → 条件確認 → 自己選択。押し切らず、合う人だけが次へ進める導線。',
    triggerType: 'manual',
    steps: [
  ...
  },
  {
    ...
    icon: '🌙',
    name: '休眠｜再接続',
    purpose: '許可 → 新しい問い → 軽い入口 → 選択 → クールダウン。反応がない人を追い続けない。',
    triggerType: 'manual',
    steps: [
