...
export const onRequest = defineMiddleware(async (context, next) => {
  ...
  const isLocalLineVisualGate = isLocalHost && (pathname === '/dashboard/line' || pathname === '/dashboard/line/');
  ...
  if (!isLocalLineVisualGate && (isFlowMindPage || isDashboardPage || isDashboardApi || isHarnessApi)) {
