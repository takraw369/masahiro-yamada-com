...
function MenuPreview({ concept, audience, compact = false }: { concept: Concept; audience: Audience; compact?: boolean }) {
  return (
    <div className={`menu-preview concept-${concept.id} ${compact ? 'compact' : ''}`}>
      <div className="menu-sky" /><div className="menu-land land-one" /><div className="menu-land land-two" />
      <div className="map-lines"><i /><i /><i /></div><div className="leaf-shadow" />
...
@media(max-width:1100px){.menu-preview.compact{min-height:300px}.compact .route-tile{min-height:55px}.studio-grid{grid-template-columns:1fr}.rows button{grid-template-columns:110px 1fr 1fr 1fr}.rows button span:last-child{display:none}}
@media(max-width:820px){.line-exp-head{grid-template-columns:1fr}.toolbar{grid-template-columns:1fr}.audience-tabs{grid-template-columns:repeat(3,1fr)}.bulk-button{min-height:44px}.experience-spine{grid-template-columns:1fr 1fr}.experience-spine>.arrow{display:none}.rule-note{grid-template-columns:1fr}.concept-grid{grid-template-columns:1fr}.menu-preview.compact{min-height:390px}.draft-actions{grid-template-columns:1fr 1fr}.draft-actions>div{grid-column:1/-1}.rows button{grid-template-columns:1fr 1fr}.rows button span:nth-child(4),.rows button span:nth-child(5){display:none}}
