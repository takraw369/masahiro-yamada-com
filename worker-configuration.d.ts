/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 70e829fee281aeb6d3afab70e240ae1c)
// Runtime types generated with workerd@1.20260804.1 2026-08-11 nodejs_compat
interface __BaseEnv_Env {
	AUTH_RATE_LIMITER: RateLimit;
	HARNESS_READ_RATE_LIMITER: RateLimit;
	HARNESS_WRITE_RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	SITE_NAME: "localhost" | "masahiro-yamada.com";
	APP_ENV: "development" | "production";
	HARNESS_PROXY_ENABLED: "false";
	HARNESS_SIDE_EFFECTS_ENABLED: "false";
	X_HARNESS_URL: "https://example.invalid" | "https://x-harness-worker.takraw501.workers.dev";
	LINE_HARNESS_URL: "https://example.invalid" | "https://line-crm-worker.takraw501.workers.dev";
	DASHBOARD_DEV_PASSWORD?: string;
	DASHBOARD_DEV_OPERATOR_PASSWORD?: string;
	DASHBOARD_DEV_SESSION_SECRET?: string;
	DB?: D1Database;
	DASHBOARD_PASSWORD?: string;
	DASHBOARD_OPERATOR_PASSWORD?: string;
...
declare namespace Cloudflare {
	interface DevelopmentEnv {
		...
		HARNESS_PROXY_ENABLED: "false";
		HARNESS_SIDE_EFFECTS_ENABLED: "false";
		X_HARNESS_URL: "https://example.invalid";
		LINE_HARNESS_URL: "https://example.invalid";
		DASHBOARD_DEV_PASSWORD: string;
		DASHBOARD_DEV_OPERATOR_PASSWORD: string;
		DASHBOARD_DEV_SESSION_SECRET: string;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SITE_NAME" | "APP_ENV" | "HARNESS_PROXY_ENABLED" | "HARNESS_SIDE_EFFECTS_ENABLED" | "X_HARNESS_URL" | "LINE_HARNESS_URL" | "DASHBOARD_DEV_PASSWORD" | "DASHBOARD_DEV_OPERATOR_PASSWORD" | "DASHBOARD_DEV_SESSION_SECRET" | "DASHBOARD_PASSWORD" | "DASHBOARD_OPERATOR_PASSWORD" | "DASHBOARD_SESSION_SECRET" | "X_HARNESS_API_KEY" | "LINE_HARNESS_API_KEY">> {}
}
